...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Example:} \underline{Sodium} (\ce{Na} 钠) and \underline{chlorine} (\ce{Cl} 氯) form sodium chloride (\ce{NaCl} 氯).
...
\begin{itemize}
    ...
    \end{figure}
    \item \textbf{Examples:} Formation of \underline{hydrogen} (\ce{H2} 氢气) molecules and the formation of \underline{water}
    (\ce{H2O} 水).
    \begin{figure}[H]
        \centering
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Polar Molecule:} Water (\ce{H2O}) has a bent structure with a partial charges (see figure 2.2) - oxygen is
...
\begin{itemize}
    \item \textbf{Nitrate Ions (\ce{NO3^-} 硝酸根离子):} Vital for DNA \footnote{\textbf{DNA (Deoxyribonucleic Acid 脱氧核糖核酸):} DNA
    ...
    \item \textbf{Phosphate Ions (\ce{PO4^3-} 磷酸根离子):} Essential for ATP \footnote{\textbf{ATP (Adenosine Triphosphate
    ...
    (肌球蛋白).}
    \item\textbf{Chloride Ions (\ce{Cl^-} 氯离子):} Needed in all living organisms to make ATP and ADP as well as DNA and RNA.
    \item \textbf{Hydrogencarbonate Ions (\ce{HCO3^-} 碳酸氢根离子):} Needed in nerve impulses, sweating, and many
    \underline{secretory systems} (分泌系统) in animals.
    \item \textbf{Sodium Ions (\ce{Na^+} 钠离子):} Critical in nerve impulses and secretory functions.
    \item \textbf{Magnesium Ions (\ce{Mg^2+} 镁离子):} Needed for production of \underline{chorophyll} (叶绿素) in plants.
    \item \textbf{Hydrogen Ions (\ce{H^+} 氢离子):} Needed in cellular \underline{respiration} (呼吸) and \underline{photosynthesis}
    (光合作用), and in numerous pumps and systems as well as pH balance.
    \item \textbf{Calcium Ions (\ce{Ca^2+} 钙离子):} Needed for the formation of \underline{calcium pectate} (果胶酸钙) for middle
